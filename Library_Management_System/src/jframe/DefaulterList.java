...
public class DefaulterList extends javax.swing.JFrame {
    ...
    public void setIssueBookDetails() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                // Parse the due_date from the result set
                java.sql.Date dueDateSql = rs.getDate("due_date");

                // Calculate the overdue days directly (using today's date and due date)
                long overdueDays = (todaysDate.getTime() - dueDateSql.getTime()) / (1000 * 60 * 60 * 24);  // Convert milliseconds to days

                // If overdue days is positive, calculate the fine (10 Rs per day), otherwise set fine to 0
                int fine = overdueDays > 0 ? (int) (overdueDays * 10) : 0;

                // Prepare the row with the fine included
    ...
    private void initComponents() {
        ...
        jPanel1.add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 210, 1230, 300));
        ...
        jPanel1.add(jPanel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 120, 280, 5));
        ...
        jPanel1.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 60, 230, 50));
